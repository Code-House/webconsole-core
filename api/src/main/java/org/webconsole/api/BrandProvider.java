...
public interface BrandProvider {
     ...
     * 
     * @param imageId Identifier of header element.
     * @return Header component
     */
    Component getHeader(String headerId);

    /**
     * Creates footer element.
     * 
     * @param footerId Identifier of footer element.
     * @return Footer component.
     */
    Component getFooter(String footerId);
